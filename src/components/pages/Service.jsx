...
function Service() {
  ...
  const ServiceCard = ({ service, index }) => {
    ...
    return (
      <div
        ref={cardRef}
        className={`mb-10 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-700`}
      >
        <Link to={service.link} className="block group">
          <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-6 items-center`}>
            {/* Image Section */}
            <div className={`w-full lg:w-2/5 ${isEven ? 'lg:pr-6' : 'lg:pl-6'}`}>
            ...
            {/* Content Section */}
            <div className={`w-full lg:w-3/5 ${isEven ? 'lg:pl-6' : 'lg:pr-6'}`}>
              <div className="bg-white rounded-xl p-6 shadow-lg group-hover:shadow-xl transition-all duration-500 border border-gray-100">
                <div className="mb-3">
      ...
      >
        <div className="relative z-10 container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-200 animate-fade-in-up-delay leading-relaxed">
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link
              to="/contact"
              className="inline-block bg-white text-blue-600 px-8 py-4 rounded-full font-semibold text-lg shadow-2xl hover:bg-blue-50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-3xl"
            >
              Get in Touch
            </Link>
          </div>
