      ...
      >
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 text-white animate-fade-in-up" style={{textShadow: '2px 2px 8px rgba(0,0,0,0.8)'}}>Media, Entertainment & Gaming</h1>
