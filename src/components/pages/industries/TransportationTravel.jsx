    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 text-white animate-fade-in-up" style={{textShadow: '2px 2px 8px rgba(0,0,0,0.8)'}}>Transportation & Travel</h1>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white px-6 py-8 rounded-xl">
                  ...
                  <div className="text-sm opacity-90">Travel Projects</div>
                </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-3xl p-12 shadow-2xl">
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Our Solutions</h3>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="container mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6 text-gray-800">Transform Transportation & Travel</h2>
