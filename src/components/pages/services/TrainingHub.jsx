    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Training Hub Background"
            className="w-full h-full object-cover"
          />
        </div>
        <div className="relative z-10 container mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Training Hub</h1>
            <p className="text-xl text-gray-200 leading-relaxed">
              Comprehensive training solutions to upskill your workforce and drive business growth
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                Our training programs are designed to enhance your team's capabilities, 
                boost productivity, and keep your organization ahead of industry trends.
              </p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-3xl p-12 shadow-2xl">
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Training Services</h3>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="container mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6 text-gray-800">Invest in Your Team's Growth</h2>
          <p className="text-xl mb-8 text-gray-600 max-w-2xl mx-auto">
            Transform your workforce with our comprehensive training solutions
          </p>
          <a
            href="/contact"
